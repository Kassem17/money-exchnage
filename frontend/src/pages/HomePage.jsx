            ...
            {[
              ...
              >
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-bold text-blue-100">{feature.title}</h4>
                    <p className="mt-1 text-gray-300 text-sm">{feature.desc}</p>
                  </div>
                </div>
              </motion.div>
            ))}
          ...
          <div className="space-y-4" dir="rtl">
            {[
              ...
              <div className="flex items-start space-x-3" key={idx}>
                ...
                <div>
                  <h4 className="font-semibold text-blue-100">{item.title}</h4>
